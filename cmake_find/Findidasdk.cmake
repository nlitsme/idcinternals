...
if(WIN32)
    ...
    find_library(IDALIB32 ida ${IDASDK_PATH}/lib/x64_win_vc_32)
    find_library(IDALIB64 ida ${IDASDK_PATH}/lib/x64_win_vc_64)
elseif(LINUX)
    find_library(IDALIB32 ida ${IDASDK_PATH}/lib/x64_linux_gcc_32)
    find_library(IDALIB64 ida64 ${IDASDK_PATH}/lib/x64_linux_gcc_64)
elseif(DARWIN)
    find_library(IDALIB32 ida ${IDASDK_PATH}/lib/x64_mac_clang_32)
    find_library(IDALIB64 ida64 ${IDASDK_PATH}/lib/x64_mac_clang_64)
elseif(MACARM)
    # todo ... how do I detect this from my cmake script?
    find_library(IDALIB32 ida ${IDASDK_PATH}/lib/arm64_mac_clang_32)
    find_library(IDALIB64 ida64 ${IDASDK_PATH}/lib/arm64_mac_clang_64)
endif()
